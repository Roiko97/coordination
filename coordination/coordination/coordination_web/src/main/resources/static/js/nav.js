...
name.innerHTML = "<strong><img src='http://localhost:8088/coordination/static/src/name.png' alt='姓名'></strong>";
num.innerHTML = "<strong><img src='http://localhost:8088/coordination/static/src/grade.png' alt='年级'></strong>";
grade.innerHTML = "<strong><img src='http://localhost:8088/coordination/static/src/num.png' alt='学号'></strong>";
...
function createTast() {
    ...
    task_p.innerHTML = "<img src='http://localhost:8088/coordination/static/src/task.png'alt='任务'>里程碑";
    ...
    nav_li_1.innerHTML =
        "<a href='#nostart' data-toggle='tab' ><img src='http://localhost:8088/coordination/static/src/nostart.png'alt='未开始'>未开始</a>";
    nav_li_2.setAttribute("role", "presentation");
    nav_li_2.classList.add("active");
    nav_li_2.innerHTML =
        "<a href='#doing' data-toggle='tab' ><img src='http://localhost:8088/coordination/static/src/doing.png'alt='进行中'>进行中</a>";
    nav_li_3.setAttribute("role", "presentation");
    nav_li_3.innerHTML =
        "<a href='#end' data-toggle='tab' ><img src='http://localhost:8088/coordination/static/src/finsh.png'alt='完成'>完成</a>";
