...
function openModual(str) {
    ...
    switch (str) {
        case "大三":
            ...
            list[2].setAttribute("src", "http://localhost:8088/coordination/static/src/refresh-lock.png");
            list[1].parentNode.setAttribute("class", "refresh-lock");
            list[1].setAttribute("src", "http://localhost:8088/coordination/static/src/refresh-lock.png");
            list[0].parentNode.setAttribute("class", "refresh-lock");
            list[0].setAttribute("src", "http://localhost:8088/coordination/static/src/refresh-lock.png");
            break;
        case "大二":
            list[2].parentNode.setAttribute("class", "lock");
            list[2].setAttribute("src", "http://localhost:8088/coordination/static/src/lock.png");
            list[1].parentNode.setAttribute("class", "refresh-lock");
            list[1].setAttribute("src", "http://localhost:8088/coordination/static/src/refresh-lock.png");
            list[0].parentNode.setAttribute("class", "refresh-lock");
            list[0].setAttribute("src", "http://localhost:8088/coordination/static/src/refresh-lock.png");
        ...
        default:
            ...
            list[1].setAttribute("src", "http://localhost:8088/coordination/static/src/lock.png");
            list[0].parentNode.setAttribute("class", "refresh-lock");
            list[0].setAttribute("src", "http://localhost:8088/coordination/static/src/refresh-lock.png");
            break;
    }
