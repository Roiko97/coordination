...
//修改职位
function amendPosition(obj){
    var num = obj.parentNode.parentNode.firstChild.firstChild.innerHTML;
    var position = obj.value;
    $.ajax({
        type: "POST",
        url: "http://localhost:8989/team/positionRevice",
        data: {
